...
if (process.env.NODE_ENV === 'development' && mongoose.models.CourseReport) {
  delete mongoose.models.CourseReport
  if (mongoose.modelSchemas) delete mongoose.modelSchemas.CourseReport
}
...
export const ReportTemplate =
  ...
  mongoose.model('ReportTemplate', templateSchema)
